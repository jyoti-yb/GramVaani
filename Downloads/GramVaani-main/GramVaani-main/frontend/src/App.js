    ...
    <div className="container">
        ...
        <div className="logo">
          ...
          <div className="user-info">
            ...
            <div className="user-actions">
              <button onClick={() => setShowProfile(true)} className="profile-btn" data-testid="profile-btn">
                <User size={20} />
              </button>
      ...
      <div className="main-card">
        ...
        <div className="feature-buttons">
          <button className="feature-card" onClick={getMyWeather} disabled={isProcessing} data-testid="my-weather-btn">
          ...
          <button className="feature-card" onClick={() => openModal('weather')} data-testid="other-weather-btn">
            <div className="icon">🌍</div>
            <div className="title">Other City Weather</div>
            <div className="description">Check weather for any city</div>
          </button>
          <button className="feature-card" onClick={() => openModal('crop')} data-testid="crop-prices-btn">
            <div className="icon">💰</div>
            <div className="title">Crop Prices</div>
            <div className="description">Check prices for any crop</div>
          </button>
          <button className="feature-card" onClick={() => openModal('schemes')} data-testid="schemes-btn">
            <div className="icon">🏛</div>
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              ...
              <button className="submit-button" onClick={handleModalSubmit} disabled={!modalInput.trim()} data-testid="modal-submit">Get Information</button>
            </div>
          </div>
        </div>
      )}
