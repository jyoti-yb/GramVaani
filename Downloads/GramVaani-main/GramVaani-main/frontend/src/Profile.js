...
import { ArrowLeft, Edit2, Save, X, User, MapPin, Globe, Calendar, MessageSquare, TrendingUp, Activity, Award, Menu } from 'lucide-react'
    ...
    <div className="profile-container">
      <div className="profile-hero">
        ...
        <div className="hero-content">
          ...
          <p className="profile-subtitle">{user?.phone}</p>
        </div>
      </div>
