...
function Auth({ onLogin }) {
  ...
  const [step, setStep] = useState(1) // 1: Phone entry, 2: OTP verification, 3: Complete form (signup only)
  ...
  const verifyOTPAndProceed = async () => {
    ...
    if (isLogin) {
      // For login, verify OTP + password together
      await handleLogin()
    } else {
      // For signup, move to step 3 to collect other details
      setStep(3)
      setError('')
    }
  }
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        ...
        {/* Step 2: OTP Verification + Password (for login) */}
        {step === 2 && (
          <div className="auth-form">
